 ...
 */
public class StandardShipment extends Shipment implements Serializable {
    ...
    public StandardShipment(int id, String sender, String recipient, double distanceKm, double weightKg) {
